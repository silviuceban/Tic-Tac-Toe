...
function clickfunc() {
  if (this.textContent === "" &&
      document.querySelector("#x").getAttribute("style")==="background-color:#1cd591") {
    this.textContent = "X";
    ...
    sign_o.removeEventListener("click", pick_sign);
      ...
      document.querySelector("#o").getAttribute("style")==="background-color:#1cd591") {
    this.textContent = "O";
...
function check_winner(){
  if (tdlist[0].textContent === tdlist[1].textContent &&
      ...
      tdlist[0].textContent !== ""){
        ...
        remove_hover_from_sign_boxes();
  }else if (tdlist[3].textContent === tdlist[4].textContent &&
            ...
            tdlist[3].textContent !== "") {
              ...
              fill_the_blanks();
              remove_hover_from_sign_boxes();
  }else if (tdlist[6].textContent === tdlist[7].textContent &&
            ...
            tdlist[6].textContent !== "") {
              ...
              fill_the_blanks();
              remove_hover_from_sign_boxes();
  }else if (tdlist[0].textContent === tdlist[3].textContent &&
            ...
            tdlist[0].textContent !== "") {
              ...
              fill_the_blanks();
              remove_hover_from_sign_boxes();
  }else if (tdlist[1].textContent === tdlist[4].textContent &&
            ...
            tdlist[1].textContent !== "") {
              ...
              fill_the_blanks();
              remove_hover_from_sign_boxes();
  }else if (tdlist[2].textContent === tdlist[5].textContent &&
            ...
            tdlist[2].textContent !== "") {
              ...
              fill_the_blanks();
              remove_hover_from_sign_boxes();
  }else if (tdlist[0].textContent === tdlist[4].textContent &&
            ...
            tdlist[0].textContent !== "") {
              ...
              fill_the_blanks();
              remove_hover_from_sign_boxes();
  }else if (tdlist[2].textContent === tdlist[4].textContent &&
